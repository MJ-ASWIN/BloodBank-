...
# Fallback to SQLite automatically if MySQL isn't reachable / not configured.
# This lets the exact same codebase run instantly for local testing/demo,
# while production simply needs a real MySQL server + the env vars above.
USE_SQLITE_FALLBACK = os.environ.get("USE_SQLITE", "1") == "1"

if USE_SQLITE_FALLBACK:
    app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///blood_network.db"
else:
